...
public class Math3d {
    ...
    public static Vector3 ProjectPointOnLine(Vector3 linePoint, Vector3 lineVec, Vector3 point) {
        ...
        float t = Vector3.Dot(linePointToPoint, lineVec.normalized);

        return linePoint + lineVec.normalized * t;
    }
    ...
    /// <param name="point"></param>
    /// <returns></returns>
    public static float SignedDistanceLinePoint(Vector3 linePoint, Vector3 lineDir, Vector3 point)
    {
        return Mathf.Sin(Vector3.Angle(linePoint - point, lineDir)) * Vector3.Distance(linePoint, point);
    }
    ...
    public static void LookRotationExtended(
        ref GameObject gameObjectInOut, 
    ...
    public static void LookRotationExtendedB(
        ref GameObject gameObjectInOut,
        Vector3 alignWithVector,
        Vector3 alignWithNormal)
    {
        ...
        //Calculate the rotation
        gameObjectInOut.transform.rotation = rotationA;
    }
